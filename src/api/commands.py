        ...
        try:
            ...
            vehicles = [
                Vehicle(marca_modelo="AUDI A3",
                        ...
                        precio= 50,
                        user_id= users[0].id, 
                        precio_id_stripe= "price_1PPLyyHB7oLooSPWYXaiIfA7",
                        producto_id_stripe = "prod_QFriW3eG5BAlVW",
                        ...
                        fecha_inicio = datetime.date(2024, 6, 13),
                        fecha_fin = datetime.date(2024, 6, 16),
                    ),
                ...
                Vehicle(marca_modelo="TOYOTA AURIS",
                        ...
                        precio= 55,
                        user_id= users[0].id, 
                        precio_id_stripe= "price_1PPLzkHB7oLooSPWt5BRHsLU",
                        producto_id_stripe = "prod_QFrjLpJaucfSDO",
                ...
                Vehicle(marca_modelo="FIAT 500",
                        ...
                        precio= 30,
                        user_id= users[0].id, 
                        precio_id_stripe= "price_1PPM0PHB7oLooSPWMJOJo1fB",
                        producto_id_stripe = "prod_QFrjBC28UQE378",
                ...
                Vehicle(marca_modelo="TESLA S",
                        ...
                        precio= 105,
                        user_id= users[0].id, 
                        precio_id_stripe= "price_1PPM12HB7oLooSPW1kKHcr8u",
                        producto_id_stripe = "prod_QFrk1UIOgMIKZL",
                ...
                Vehicle(marca_modelo="CITROEN C5",
                        ...
                        precio= 60,
                        user_id= users[0].id, 
                        precio_id_stripe= "price_1PPM1gHB7oLooSPWiYHauCCI",
                        producto_id_stripe = "prod_QFrlakyulfkjfw", 
                ...
                Vehicle(marca_modelo="MERCEDES VITO",
                        ...
                        precio= 120,
                        user_id= users[0].id, 
                        precio_id_stripe= "price_1PPM2JHB7oLooSPWlKjkR2pA",
                        producto_id_stripe = "prod_QFrlWEEGzgp9eI", 
