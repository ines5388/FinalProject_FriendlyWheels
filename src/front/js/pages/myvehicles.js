                    ...
                    {store.myVehicles.length === 0 
                        ? (
                            <>
                                ...
                                <div>Pulsa en el botón añadir que se muestra a continuación para añadir tu primer coche</div>
                                <Link to={`/addvehicle`}>
                                    <div className="mt-3">
                            ...
                            <>
                                ...
                                <div className="row text-dark d-flex gap-4 justify-content-center">
                                    {store.myVehicles.map((vehicle) => (
                                        <div key={vehicle.id} className="card-vehicle card" style={{ width: "22rem", height: "27rem"}}>
