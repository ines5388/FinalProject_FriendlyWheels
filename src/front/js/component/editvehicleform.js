...
export const EditVehicleForm = (props) => {
    ...
    return (
        <div className="lg-5">
            <h1 className="mx-2 pb-4 text-success text-center"><strong>EDITE SU COCHE </strong></h1>
            <form onSubmit={formik.handleSubmit}>
                ...
                <div>
                    <Container>
                        <h4 className="add-edit-form-subtitles">Si quiere editar sus fotos actuales, seleccione tres imágenes nuevas de su coche</h4>
