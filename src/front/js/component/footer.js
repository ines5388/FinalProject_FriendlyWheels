...
export const Footer = () => {
	...
	return (
		<footer className="fs-4 d-flex justify-content-between">
			...
			<div className="d-flex justify-content-end mt-4">
				<Link to="/aboutus" style={linkStyle} onMouseOver={() => setAboutUsHover(true)} onMouseLeave={() => setAboutUsHover(false)}>
					<div className="me-3 mt-2 fs-3">Sobre Nosotros</div>
				</Link>
				<div className="footericons d-none d-lg-block d-xl-block">
